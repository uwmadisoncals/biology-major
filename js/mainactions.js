...
var countFeatures = 0;
 	 ...
 	 var calsWPTheme = {
	    ...
	    init: function() {
    	    ...
    	    $("#mobile-filter-inner").css("-webkit-transform", "scale(0.8)");
			    ...
			    var orignav = $(".menu-menu-1-container").first().html();
    ...
    $('.mobileNavTriggerLarge').bind('touchstart', function(){
    	...
    	$(".mobileNavTriggerLarge").hide();
    	    ...
    	    $("#mobile-menu-inner").css("-webkit-transition", "0.3s");
    	    $("#mobile-menu-inner").css("-webkit-transform", "scale(0.8)");
    	    $("#branding").css("-webkit-transition", "0.3s");
    	    $("#branding").css("-webkit-transform", "translate3d(0px,0,0)");
    	...
    	if(menushown) {
    	   ...
    	   /* $("#access").css("-webkit-transition", "0.3s");
    	    ...
    	    $("#branding").css("-webkit-transition", "0.3s");	
    	    $("#branding").css("-webkit-transform", "translate3d(240px,0px,0)");
    ...
    if(filtershown) {
    	    ...
    	    $("#branding").css("-webkit-transition", "0.3s");
    	    $("#branding").css("-webkit-transform", "translate3d(-240px,0,0)");
    	    filtershown = true;
